...
int main( int argc, char* argv[] ) {
  ...
  // Output the items pointed to by vector elements using an iterator: https://stackoverflow.com/questions/31478897/how-to-iterate-over-a-vector#31478934
  for (DataNode* i : aVector) {
    cout << *i << endl;
  }
  cout << endl;
